...
* **Resource Pages**: Located in `.claude/wiki/resources/<page_name>.md`
* **Pattern Pages**: Located in `.claude/wiki/patterns/<page_name>.md`
* **Gotcha Pages**: Located in `.claude/wiki/gotchas/<page_name>.md`

### Mandatory (Always Read — 2 pages)
- `.claude/wiki/improvements/naming-conventions.md`
- `.claude/wiki/improvements/code-improvement-checklist.md`
...
Read the FULL improvement checklist from: `.claude/wiki/improvements/code-improvement-checklist.md`

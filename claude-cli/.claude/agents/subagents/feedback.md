...
After analyzing pipeline metrics, lint the Knowledge Wiki at `.claude/wiki/`:
...
- For each resource type, check if a wiki entity page exists in `.claude/wiki/resources/`

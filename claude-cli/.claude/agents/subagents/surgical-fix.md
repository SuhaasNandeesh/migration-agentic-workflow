...
- If you have failed two previous attempts on the same file/error:
  ...
  3. **Ingest Resolution:** When you are re-triggered for Attempt 3 (after Supervisor has processed the request and cached the real-world resolution into `.claude/wiki/gotchas/<resource_type>_fix.md`), read this newly generated JIT fix guide.

...
After analyzing pipeline metrics, lint the Knowledge Wiki at `.gemini/wiki/`:
...
- For each resource type, check if a wiki entity page exists in `.gemini/wiki/resources/`

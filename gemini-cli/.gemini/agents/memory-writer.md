...
```json
{
  "entries_written": [
    {
      "file": ".gemini/skills/memory-store/assets/path",
      "entry": {
        "problem": "",
        "fix": "",
        "tags": [],
...
## Target Locations
- Structured entries → `.gemini/skills/memory-store/assets/structured/issues.json`
- Documentation → `.gemini/skills/memory-store/assets/docs/issues_and_fixes.md`
- Execution traces → `.gemini/skills/memory-store/assets/traces/`
- Progress updates → `.gemini/skills/memory-store/assets/docs/progress.md`

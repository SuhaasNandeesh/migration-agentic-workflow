...
```json
{
  "entries_written": [
    {
      "file": ".opencode/skills/memory-store/assets/path",
      "entry": {
        "problem": "",
        "fix": "",
        "tags": [],
...
## Target Locations
- Structured entries → `.opencode/skills/memory-store/assets/structured/issues.json`
- Documentation → `.opencode/skills/memory-store/assets/docs/issues_and_fixes.md`
- Execution traces → `.opencode/skills/memory-store/assets/traces/`
- Progress updates → `.opencode/skills/memory-store/assets/docs/progress.md`

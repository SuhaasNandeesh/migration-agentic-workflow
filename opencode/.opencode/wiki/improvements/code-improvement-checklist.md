...
| 5 | No tags/labels | Add comprehensive tags (environment, project, managed-by, cost-center) recursively to all resources whose provider schemas support a `tags` attribute. | major |
...
- **All taggable resources have tags** → if missing or omitted on supported resources → **FAIL (major)**

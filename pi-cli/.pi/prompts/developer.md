...
* **Resource Pages**: Located in `.pi/wiki/resources/<page_name>.md`
* **Pattern Pages**: Located in `.pi/wiki/patterns/<page_name>.md`
* **Gotcha Pages**: Located in `.pi/wiki/gotchas/<page_name>.md`

### Mandatory (Always Read — 2 pages)
- `.pi/wiki/improvements/naming-conventions.md`
- `.pi/wiki/improvements/code-improvement-checklist.md`
...
Read the FULL improvement checklist from: `.pi/wiki/improvements/code-improvement-checklist.md`
